    ...
    return (
        <>
            <div className="bg-dungeon-dark-500 border-dungeon-yellow border text-2xl font-bold flex flex-col justify-start m-5"> 
                <div className="flex md:flex-row flex-col gap-3 items-center justify-between p-5">
                    <span className="font-bold text-3xl">{dungeon.name}</span>
                    <div className="flex flex-row gap-2 items-center *:p-2 *:rounded-xl *:hover:bg-dungeon-yellow *:transition-colors">
