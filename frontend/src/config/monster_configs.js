...
const MONSTER_TEMPLATES = [
    ...
    { id: "spider", name: "Spider", health: 12, attack: 5, xp: 1, difficulty: 1, allowed_tiers: ["Weak", "Normal"] },
    ...
    { id: "vrusenu", name: "Vrusenu", health: 75, attack: 55, xp: 25, difficulty: 0, allowed_tiers: ["Boss"] },
    { id: "baby_dragon", name: "Baby Dragon", health: 50, attack: 35, xp: 25, difficulty: 10, allowed_tiers: ["Boss"] },
    { id: "dragon", name: "Dragon", health: 75, attack: 55, xp: 25, difficulty: 10, allowed_tiers: ["Boss"] },
];
